...
fn test_get_or_insert_returns_inserted_value() {
    ...
    assert_eq!(retrieved.load(Ordering::Relaxed), 100, 
...
fn test_get_or_insert_identity() {
    ...
    assert!(Arc::ptr_eq(&returned1, &arc1) || Arc::ptr_eq(&returned1, &Arc::new(AtomicU64::new(42))),
