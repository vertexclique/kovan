//! Bounded MPMC (4 senders x 4 receivers) throughput.
...
fn bench_bounded_mpmc(c: &mut Criterion) {
    let mut group = c.benchmark_group("bounded_mpmc_4x4");
    group.sample_size(20);
    group.throughput(Throughput::Elements(TOTAL));

    group.bench_function("cap_1024", |b| {
        b.iter(|| {
...
criterion_group!(benches, bench_bounded_mpmc);
